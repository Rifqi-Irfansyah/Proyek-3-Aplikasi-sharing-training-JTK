    ...
    <div class="row justify-content-center w-100">
        <div class="col-md-6">
            <div class="rounded-5 p-5 shadow box-area bg-white text-center position-relative">
                <a href="{{ route('login') }}" class="btn btn-primary rounded-circle position-absolute" style="background-color: #6cace4; top: 20px; left: 20px; width: 35px; height: 35px; display: flex; justify-content: center; align-items: center;">
                ...
                <form action="{{ route('training.store') }}" method="POST" class="w-100">
                    ...
                    <div class="form-group mb-3 text-start">
                        ...
                        <input type="number" class="form-control" id="jumlah_pertemuan" name="jumlah_pertemuan" min="1" required>
                    </div>
